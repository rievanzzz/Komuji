...
import MiluanImage from '../assets/img/Miluan Event.png';

const PublicFooter = () => {
  const footerLinks = {
    company: [
      { name: 'About', href: '/about' },
      { name: 'Blog', href: 'https://medium.com/', external: true },
      { name: 'Careers', href: 'mailto:hr@miluan.com', external: true },
      { name: 'Contact', href: '/contact' }
    ],
    product: [
      { name: 'Browse Events', href: '/events' },
      { name: 'Create Event', href: '/organizer-login' },
      { name: 'Upgrade to Organizer', href: '/upgrade-to-panitia' },
  ...
  const FooterImage = () => (
    <div className="w-32 h-32 overflow-hidden rounded-lg bg-white border border-gray-200 flex items-center justify-center">
      <img
        src={MiluanImage}
        alt="Miluan brand"
            ...
            >
              ...
              <div className="space-y-3">
                <motion.a
                  ...
                  className="flex items-center space-x-3 text-gray-600 text-sm group"
                ...
                {footerLinks.company.map((link, index) => (
                  ...
                  >
                    {isExternal(link.href) ? (
                      <a href={link.href} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#59789F] transition-colors text-sm relative group">
                      ...
                      <Link to={link.href} className="text-gray-600 hover:text-[#59789F] transition-colors text-sm relative group">
                        <span className="relative">
                          {link.name}
                          <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#ECE69D] group-hover:w-full transition-all duration-300"></span>
                        </span>
