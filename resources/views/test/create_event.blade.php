...
<head>
    ...
    <title>Test Buat Event</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h2>Test Buat Event</h2>
        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="approval_type" name="approval_type" required>
                    <option value="auto">Otomatis Disetujui</option>
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="flyer" name="flyer" accept="image/jpeg,image/png,image/jpg" required>
